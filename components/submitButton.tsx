...
import { AnySchema, ValidationError } from 'yup'; // Assuming you're using Yup for validation
    ...
    if (validationSchema) {
      try {
        ...
        if (validationErrors instanceof ValidationError) {
          const errorMessages = validationErrors.inner?.map((err: ValidationError) => err.message).join(', ') || validationErrors.message;
